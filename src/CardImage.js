...
export default function CardImage(props) {
    ...
    return (
        <Stack spacing={0}>
            ...
            >
                <img id="pastedImage" style={{width:width,height:height,border: "3px solid gray"}} src={photoUrl} ></img>
            </Box>
            <Box
                sx={{
                    width: width,
